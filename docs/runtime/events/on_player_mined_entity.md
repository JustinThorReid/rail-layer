# Event: on_player_mined_entity

Called after the results of an entity being mined are collected just before the entity is destroyed.
After this event any items in the buffer will be transferred into the player as if they came from
...
| ---- | ---- | -------- | ----------- |
| `player_index` | `uint32` | no | The index of the player doing the mining. |
