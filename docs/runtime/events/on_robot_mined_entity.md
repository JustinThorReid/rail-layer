# Event: on_robot_mined_entity

Called after the results of an entity being mined are collected just before the entity is destroyed.
After this event any items in the buffer will be transferred into the robot as if they came from
...
| ---- | ---- | -------- | ----------- |
| `robot` | `LuaEntity` | no | The robot doing the mining. |
