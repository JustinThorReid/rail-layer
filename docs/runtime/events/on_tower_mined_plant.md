# Event: on_tower_mined_plant

Called after the results of an entity being mined are collected just before the entity is destroyed.
After this event any items in the buffer will be transferred into the tower as if they came from
...
| ---- | ---- | -------- | ----------- |
| `tower` | `LuaEntity` | no | The tower doing the mining. |
| `plant` | `LuaEntity` | no | The entity that has been mined. |
